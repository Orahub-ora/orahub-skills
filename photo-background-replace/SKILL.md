...
- If the original image is a URL and no output path is provided, save to `./output/photo-background-replace/{YYYY-MM-DD}_{original_stem_or_index}_ora_background_replace.jpg`
